    ...
    request({url, json: true}, (error, {body}) => {
        ...
        if (error) {
            ...
            callback(undefined, {
                ...
                textSummary : body.daily.data[0].summary +
                    ' It is currently ' + body.currently.temperature + ' degress out. ' +
                    'There is a ' + body.currently.precipProbability + '% chance of rain.' +
                    ' Todays lowest temperature will be ' + body.daily.data[0].temperatureLow + ' and todays high will be ' + body.daily.data[0].temperatureHigh + 
                    '. The UV index for taday is ' + body.currently.uvIndex
            });
        }
    });
};
